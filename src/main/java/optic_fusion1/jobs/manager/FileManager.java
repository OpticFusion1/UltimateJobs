...
public class FileManager {
    ...
    public FileManager(UltimateJobs plugin) {
        this.plugin = plugin;
    }
    ...
    public void createDefaultJobs() {
        for (String b : defaultjobs) {
            File f = new File(plugin.getDataFolder(), "jobs" + File.separatorChar + b + ".yml");
            if (!f.exists()) {
                f.getParentFile().mkdirs();
                plugin.saveResource("jobs" + File.separatorChar + b + ".yml", false);
            }
        }
    }
    ...
    public void createDefaultSongs() {
        for (String b : defaultsongs) {
            File f = new File(plugin.getDataFolder(), "addons" + File.separatorChar + "songs" + File.separatorChar + b + ".nbs");
            if (!f.exists()) {
                f.getParentFile().mkdirs();
                plugin.saveResource("addons" + File.separatorChar + "songs" + File.separatorChar + b + ".nbs", false);
            }
        }
    }
    ...
    public void createDefaultLanguages() {
        for (String b : defaultlanguages) {
            ...
            File folder_1 = new File(plugin.getDataFolder() + "/lang/", b);
            ...
            for (String file : defaultlanguages_files) {
                File f = new File(plugin.getDataFolder() + "/lang/" + b + "/", file + ".yml");
                if (!f.exists()) {
                    f.getParentFile().mkdirs();
                    plugin.saveResource("lang/" + b + "/" + file + ".yml", false);
                }
            }
        }
    }
    ...
    public boolean createDailyQuestsSettingFile() {
        q_settings_file = new File(plugin.getDataFolder(), "addons" + File.separatorChar + "dailyquests" + File.separatorChar + "quests_settings.yml");
        if (!q_settings_file.exists()) {
            q_settings_file.getParentFile().mkdirs();
            plugin.saveResource("addons" + File.separatorChar + "dailyquests" + File.separatorChar + "quests_settings.yml", true);
        }
    ...
    public boolean createDailyQuestsTypeFile() {
        q_types_file = new File(plugin.getDataFolder(), "addons" + File.separatorChar + "dailyquests" + File.separatorChar + "quests_types.yml");
        if (!q_types_file.exists()) {
            q_types_file.getParentFile().mkdirs();
            plugin.saveResource("addons" + File.separatorChar + "dailyquests" + File.separatorChar + "quests_types.yml", true);
        }
    ...
    public boolean createRankingPerJobFile() {
        jobr_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "ranking_per_job.yml");
        if (!jobr_file.exists()) {
            jobr_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "ranking_per_job.yml", true);
        }
    ...
    public boolean createGlobalRankingFile() {
        globalc_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "ranking_global.yml");
        if (!globalc_file.exists()) {
            globalc_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "ranking_global.yml", true);
        }
    ...
    public boolean createUtilsFile() {
        utils_file = new File(plugin.getDataFolder(), "settings" + File.separatorChar + "utils.yml");
        if (!utils_file.exists()) {
            utils_file.getParentFile().mkdirs();
            plugin.saveResource("settings" + File.separatorChar + "utils.yml", true);
        }
    ...
    public boolean createLeaveConfirmFile() {
        cleave_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "leave_job_confirm_gui.yml");
        if (!cleave_file.exists()) {
            cleave_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "leave_job_confirm_gui.yml", true);
        }
    ...
    public boolean createWithConfirmFile() {
        withc_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "withdraw_confirm_gui.yml");
        if (!withc_file.exists()) {
            withc_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "withdraw_confirm_gui.yml", true);
        }
    ...
    public boolean createWithFile() {
        with_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "withdraw_gui.yml");
        if (!with_file.exists()) {
            with_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "withdraw_gui.yml", true);
        }
    ...
    public boolean createLangGUIFile() {
        langg_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "lang_gui.yml");
        if (!langg_file.exists()) {
            langg_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "lang_gui.yml", true);
        }
    ...
    public boolean createLangFile() {
        lang_file = new File(plugin.getDataFolder(), "settings" + File.separatorChar + "languages.yml");
        if (!lang_file.exists()) {
            lang_file.getParentFile().mkdirs();
            plugin.saveResource("settings" + File.separatorChar + "languages.yml", true);
        }
    ...
    public boolean createDataFile() {
        data_file = new File(plugin.getDataFolder(), "settings" + File.separatorChar + "data.yml");
        if (!data_file.exists()) {
            data_file.getParentFile().mkdirs();
            plugin.saveResource("settings" + File.separatorChar + "data.yml", true);
        }
    ...
    public boolean createEarningsJobFile() {
        earnings_job_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "earnings_job.yml");
        if (!earnings_job_file.exists()) {
            earnings_job_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "earnings_job.yml", true);
        }
    ...
    public boolean createEarningsAllFile() {
        earnings_all_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "earnings_all.yml");
        if (!earnings_all_file.exists()) {
            earnings_all_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "earnings_all.yml", true);
        }
    ...
    public boolean createLevelsFile() {
        levels_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "levelsgui.yml");
        if (!levels_file.exists()) {
            levels_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "levelsgui.yml", true);
        }
    ...
    public boolean createAddonRewardsFiles() {
        rewards_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "rewards.yml");
        if (!rewards_file.exists()) {
            rewards_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "rewards.yml", true);
        }
    ...
    public boolean createguistatsFiles() {
        stats_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "stats.yml");
        if (!stats_file.exists()) {
            stats_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "stats.yml", true);
        }
    ...
    public boolean createCFGFile() {
        cfg_file = new File(plugin.getDataFolder(), "Config.yml");
        if (!cfg_file.exists()) {
    ...
    public boolean createConfirmGUIFIle() {
        confirm_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "confirm_gui.yml");
        if (!confirm_file.exists()) {
            confirm_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "confirm_gui.yml", true);
        }
    ...
    public boolean createSettingsGUIFile() {
        settings_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "settings_gui.yml");
        if (!settings_file.exists()) {
            settings_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "settings_gui.yml", true);
        }
    ...
    public boolean createHelpGUIFile() {
        help_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "help_gui.yml");
        if (!help_file.exists()) {
            help_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "help_gui.yml", true);
        }
    ...
    public boolean createCMDFile() {
        cmd_file = new File(plugin.getDataFolder(), "settings" + File.separatorChar + "command.yml");
        if (!cmd_file.exists()) {
            cmd_file.getParentFile().mkdirs();
            plugin.saveResource("settings" + File.separatorChar + "command.yml", true);
        }
    ...
    public boolean createEffectsFile() {
        ef_file = new File(plugin.getDataFolder(), "settings" + File.separatorChar + "effects.yml");
        if (!ef_file.exists()) {
            ef_file.getParentFile().mkdirs();
            plugin.saveResource("settings" + File.separatorChar + "effects.yml", true);
        }
    ...
    public boolean createGUIFile() {
        gui_file = new File(plugin.getDataFolder(), "guis" + File.separatorChar + "main_gui.yml");
        if (!gui_file.exists()) {
            gui_file.getParentFile().mkdirs();
            plugin.saveResource("guis" + File.separatorChar + "main_gui.yml", true);
        }
