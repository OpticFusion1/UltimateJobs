package optic_fusion1.jobs.database.hikari;

import com.zaxxer.hikari.HikariConfig;
import com.zaxxer.hikari.HikariDataSource;
import optic_fusion1.jobs.UltimateJobs;
import optic_fusion1.jobs.database.statements.ConnectionType;
...
public abstract class HikariSetup implements ConnectionType {
    ...
    public HikariSetup init(UltimateJobs plugin, SQLTypes types, HikariAuthentication authentication, int timeOut, int poolSize) {
        this.dataSource = new HikariDataSource(getDataProperties(types, authentication, timeOut, poolSize));
        plugin.getSQLStatementAPI().setType(this);
        return this;
    }
