...
public class WorldGuardManager {
    ...
    public static StateFlag getFlagFromName(String b) {
        ...
        if (b.equalsIgnoreCase("pickup-action")) {
            return PICKUP;
        }
        if (b.equalsIgnoreCase("carve-action")) {
            return CARVE;
        }

        if (b.equalsIgnoreCase("ia-kill-action")) {
            return IA_KILL;
        }
        if (b.equalsIgnoreCase("ia-break-action")) {
            return IA_BREAK;
        }

        if (b.equalsIgnoreCase("enchant-action")) {
            return ENCHANT;
        }
        if (b.equalsIgnoreCase("explore-action")) {
            return EXPLORE;
        }
        if (b.equalsIgnoreCase("smelt-action")) {
            return SMELT;
        }
        if (b.equalsIgnoreCase("villager-trade-action")) {
            return TRADE_EMERALDS;
        }
        if (b.equalsIgnoreCase("find-treasure-action")) {
            return TR;
        }
        if (b.equalsIgnoreCase("farm-grow-action")) {
            return FARM_GROW_ACTION;
        }
        if (b.equalsIgnoreCase("strip-action")) {
            return STRIP_ACTION;
        }
        if (b.equalsIgnoreCase("honey-action")) {
            return HONEY_ACTION;
        }
        if (b.equalsIgnoreCase("eat-action")) {
            return EAT_ACTION;
        }
        if (b.equalsIgnoreCase("advancement-action")) {
            return AD_ACTION;
        }
        if (b.equalsIgnoreCase("break-action")) {
            return BREAK_ACTION;
        }
        if (b.equalsIgnoreCase("place-action")) {
            return PLACE_ACTION;
        }
        if (b.equalsIgnoreCase("kill-action")) {
            return KILL_ACTION;
        }
        if (b.equalsIgnoreCase("farm-break-action")) {
            return FARM_ACTION;
        }
        if (b.equalsIgnoreCase("fish-action")) {
            return FISH_ACTION;
        }
        if (b.equalsIgnoreCase("milk-action")) {
            return MILK_ACTION;
        }
        if (b.equalsIgnoreCase("craft-action")) {
            return CRAFT_ACTION;
        }
        if (b.equalsIgnoreCase("tame-action")) {
            return TAME_ACTION;
        }
        if (b.equalsIgnoreCase("shear-action")) {
            return SHEAR_ACTION;
        }
        if (b.equalsIgnoreCase("breed-action")) {
            return BREED_ACTION;
        }
        if (b.equalsIgnoreCase("mmkill-action")) {
            return MMKILL_ACTION;
        }
        if (b.equalsIgnoreCase("collectberrys-action")) {
            return BERRY_ACTION;
        }
        if (b.equalsIgnoreCase("killbybow-action")) {
            return KILLBYBOW;
        }
        if (b.equalsIgnoreCase("grow-saplings-action")) {
            return GROWSAP;
        }
        return null;
    }
