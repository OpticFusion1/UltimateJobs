...
public class Language {
    ...
    public Language(UltimateJobs plugin, String name, String id, String icon, String display, int data,
    ...
    public String getGUIMessage(String path) {
        ...
        return plugin.getPluginManager().toHex(this.gm.get(path).replaceAll("<prefix>", "" + getPrefix()));
    }
    ...
    public String getJobMessage(String path) {
        ...
        return plugin.getPluginManager().toHex(this.js.get(path).replaceAll("<prefix>", "" + getPrefix()));
    }
    ...
    public String getMessage(String path) {
        ...
        return plugin.getPluginManager().toHex(this.dm.get(path).replaceAll("<prefix>", "" + getPrefix()));
    }
